var cardDatabase = {
  ...
  : {
    name: "76021981_1 Сироп «со вкусом Пломбир», 1 кг",
  ...
  "В данный": {
    name: "момент остатков по этой карточке нет. Можно использовать ближайший аналог 600112 Бумага Чикен Пармеджано, 4000 шт",
    analogs: ["600108"],
  },
  "Данная": {
