...
function toggleDropdown() {
    ...
    document.querySelectorAll('.dropdown-menu.show').otherMenu => {
        if (otherMenu !== menu) {
            otherMenu.classList.remove('show');
            otherMenu.closest('.dropdown').querySelector('.dropdown-toggle').classList.remove('active');
        }
    });
...
// Добавьте бэкдроп в HTML (в конец body перед скриптами)
function addDropdownBackdrop() {
    if (!document.getElementById('dropdownBackdrop')) {
